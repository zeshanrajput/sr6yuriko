...
- `chapters/`: The source files for the Quarto book:
  - `00_identity_core.qmd`: Metatype, stream, attributes, matrix, living persona stats, and skill matrix.
  - `00_character_sheet.qmd`: Embeds the generated plain-text VTT-formatted character sheet.
  - `01_rules_and_downtime.qmd`: Fading calculations, rigger/decking shortcuts, and network setups.
  - `02_character_log.qmd`: Complete run history, karma trackers, nuyen ledgers, and contact lists.
