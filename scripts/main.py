...
def generate_ascii_sheet(char_data, verbose=False):
    ...
    weapons_lines = [
        ...
        "  - RED FOX ARRAY (3X LINK)    [10P/11P/12P | 21/23/23/16/—] (SS/SA/BF, 30c) [MAA Mounted]",
        "  - CRIMSON WASP ARRAY (2X LINK) [7P/8P/9P    | 22/20/17/12/—] (SS/SA/BF, 30c) [MAA Mounted]",
...
def post_process_json(raw_json_path, log_totals, out_json_path):
    ...
    try:
        ...
        data["longRangeWeapons"] = [
            ...
            {
                "name": "Crimson Wasp Array (2x Link-Fired)",
                "type": "Exotic Weapons",
                ...
                "pool": 18,
                "damage": "7P",
                "attackRating": "22/20/17/12/—",
                "mode": "SS/SA/BF",
                "ammunition": "30(c)",
                "wifi": [],
                "accessories": [],
                "page": "Firing Squad 44",
                "description": "Link-fired array with 2x Crimson Wasps (+2 DV array bonus, +1 AR for 2nd gun). Mounted on Shiawase Man-at-Arms.",
                "primary": True
            },
            {
                ...
                "accessories": [],
                "page": "Firing Squad 44",
                "description": "Link-fired array with 1x Red Fox & 2x Crimson Wasps (+4 DV array bonus, +2 AR). Mounted on Shiawase Man-at-Arms.",
                "primary": True
            },
            {
                "name": "Tesla Coil",
